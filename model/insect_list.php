...
try {
    ...
    if (isset($_COOKIE['user_id'])) {
        $stmt = $db->prepare("SELECT insects.insect_id AS insects_insect_id, insects.insect_name , category_name, registers.ext FROM insects INNER JOIN insect_categories ON insects.insect_category_id = insect_categories.category_id LEFT JOIN registers ON insects.insect_id = registers.insect_id AND registers.user_id = :user_id GROUP BY insects.insect_id ORDER BY insects.insect_id ASC;");
