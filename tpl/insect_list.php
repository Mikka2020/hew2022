          ...
          <ul>
            <li class="insect-img-container">
              <a href="./insect_detail.php?id=<?php echo $insect['insects_insect_id']; ?>">
                <img
                  src="<?php echo all_insect_check($_COOKIE['user_id'])[$insect['insects_insect_id']]? './../users/'.$_COOKIE['user_id'].'/'.$_COOKIE['user_id'].'-'.$insect['insects_insect_id'].'-1.jpg' : './../img/icon/no-data-icon.png'; ?>"
