...
<html lang="ja">
  <head>
    ...
    <!-- <script src="./../svg-japan/dist/svg-japan.min.js"></script> -->
    ...
    <div id="container">
      <div id="map-container">
        <svg
          ...
          y="0px"
          viewBox="0 0 854 797"
          enable-background="new 0 0 854 797"
          xml:space="preserve"
        ...
        >
          ...
          <path
            ...
            fill="#4DA9CE"
            stroke="none"
            d="M712,309L712 369 664 369 664 354 632 354 632 309 z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-7"
            ...
            fill="#4DA9CE"
            stroke="none"
            d="M665,371L794 371 794 431 664 431 664 371 z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-8"
          ...
          <path
            ...
            fill="#9899C9"
            stroke="none"
            d="M752,547L752 577 727 577 727 597 662 597 662 547 z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-14"
            ...
            fill="#9899C9"
            stroke="none"
            d="M727,599h-85v30h20v30h60.25c2.73,0,4.75-2.02,4.75-4.75V599z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-15"
            ...
            fill="#9AD47F"
            stroke="none"
            d="M662,356L662 431 582 431 582 371 632 371 632 356 z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-16"
          ...
          <path
            ...
            fill="#9AD47F"
            stroke="none"
            d="M516,433L516 493 436 493 436 453 476 453 476 433 z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-19"
          ...
          <path
            ...
            fill="#9AD47F"
            stroke="none"
            d="M628,433L628 545 596 545 596 597 560 597 560 433 z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-21"
            ...
            fill="#9AD47F"
            stroke="none"
            d="M519,433L558 433 558 597 518 597 518 433 z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-22"
            ...
            fill="#9AD47F"
            stroke="none"
            d="M640,599L640 631 660 631 660 659 580 659 580 599 z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-23"
          ...
          <path
            ...
            fill="#B3DD53"
            stroke="none"
            d="M477,557h-1v140h35.25c2.73,0,4.75-2.02,4.75-4.75V557H477z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-25"
          ...
          <path
            ...
            fill="#B3DD53"
            stroke="none"
            d="M434,453L434 495 474 495 474 555 392 555 392 453 z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-27"
          ...
          <path
            ...
            fill="#B3DD53"
            stroke="none"
            d="M432,627h-40v65.25c0,2.73,2.02,4.75,4.75,4.75H474v-45h-42V627z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-31"
          ...
          <path
            ...
            fill="#FDB42A"
            stroke="none"
            d="M372,647h-73v50h68.25c2.73,0,4.75-2.02,4.75-4.75V647z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-37"
            ...
            fill="#FDB42A"
            stroke="none"
            d="M299,595v50h73v-45.25c0-2.73-2.02-4.75-4.75-4.75H299z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-38"
            ...
            fill="#FDB42A"
            stroke="none"
            d="M297,595h-68.25c-2.73,0-4.75,2.02-4.75,4.75V645h73V595z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-39"
            ...
            fill="#FDB42A"
            stroke="none"
            d="M297,647h-73v45.25c0,2.73,2.02,4.75,4.75,4.75H297V647z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-40"
            ...
            fill="#F96F39"
            stroke="none"
            d="M102,453v90h60v-50h42v-35.25c0-2.73-2.02-4.75-4.75-4.75H102z"
            class="prefecture-map"
          ></path>
          <path
            id="pref-41"
