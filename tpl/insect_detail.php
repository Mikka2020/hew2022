  ...
  <main>
    <div class="insect-img-container">
      <img class="<?php echo insect_check($_COOKIE['user_id'], $_GET['id'])? "insect-img" : "no-insect-img"; ?>"
        src="<?php echo insect_check($_COOKIE['user_id'], $_GET['id'])? "./../users/".$_COOKIE['user_id']."/".$_COOKIE['user_id']."_".$insect_data['insects_insect_id'].'_1'.$insect_data['ext'] : "./../img/icon/no-data-detail.svg"; ?>"
